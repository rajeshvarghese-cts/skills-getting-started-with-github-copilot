...
activities = {
    ...
    "Soccer Club": {
        "description": "Learn skills and play friendly matches",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["lucy@mergington.edu", "mateo@mergington.edu"]
    },
    "Art Club": {
    ...
    "Science Olympiad": {
        "description": "Team-based STEM challenges and problem solving",
